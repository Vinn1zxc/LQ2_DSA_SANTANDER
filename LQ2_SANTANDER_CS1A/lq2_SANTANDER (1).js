...
let ternary = age >= 18 && genAverage >= 83 
...
// I.2 Convert Conditional Ternary into Regular Conditional Statement  
...
// Determine eligible course enrollment  
if (genAverage >= 85) {
...
// 1.3 Convert for loop into while loop
...
if (password === rePassword) {
    ...
    let loginUsername = prompt("Username: "); // Username input on login
    let loginPassword = prompt("Password: "); // Password input on login
